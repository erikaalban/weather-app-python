...
def display_current_weather(city):
    ...
    api_key = "9b7bac1cbc64o0da36fd874214ect64b"
...
def display_forecast_weather(city_name):
    ...
    api_key = "9b7bac1cbc64o0da36fd874214ect64b"
    api_url = (
        f"https://api.shecodes.io/weather/v1/forecast?query={city_name}&key={api_key}"
    )
...
def credit():
    ...
    print("\n[yellow]This app was built by Erika Alban.[/yellow]")
